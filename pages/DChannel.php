...
<div class="container text-center">    
  ...
  <div class="form">
    ...
    <form method="post" action="control/_DRestart.php" class="restart-form">
        <input type="submit" name="restart-form" value="Restart">
    </form>
    <form method="post" action="control/_DStop.php" class="stop-form">
        <input type="submit" name="stop-form" value="Stop">
    </form>
        <form method="post" action="control/_DStart.php" class="start-form">
        <input type="submit" name="start-form" value="Start">
    </form>  
  </div>
</div>
</div><br>
